...
<SiteCard title="USTB-All-In-One" url="https://github.com/LYOfficial/USTB-All-In-One" desc="USTB 在 Github 上的常用开源工具及资料网站统计大全" icon="/icon/icon_p.png" />
<SiteCard title="USTB-SSO" url="https://github.com/isHarryh/USTB-SSO" desc="USTB 单点登录（SSO）身份认证实现库（Python&Dart）" />
<SiteCard title="The-Beike" url="https://github.com/isHarryh/The-Beike" desc="大贝壳：北京科技大学校园助手（集成课表/选课/成绩/校园网等功能）" />
<template #outdated>
<SiteCard title="HelloUSTB" url="https://github.com/genshen/HelloUSTB" desc="USTB 校园 Android App" badge="OUTDATED" />
...
<template #outdated>
<SiteCard title="USTBJwAssistant" url="https://github.com/jacklanda/USTBJwAssistant" desc="USTB Auto Course-selecting Assistant" badge="OUTDATED" />
...
<template #outdated>
<SiteCard title="USTB-Login" url="https://github.com/gehongyan/USTB-Login" desc="北科大校园网自动登录程序" badge="OUTDATED" />
<SiteCard title="USTBNetUsageInfo" url="https://github.com/Soulter/USTBNetUsageInfo" desc="北科大校园网使用情况查询" badge="OUTDATED" />
<SiteCard title="luci-app-ustb-net" url="https://github.com/cc-404/luci-app-ustb-net" desc="OpenWrt/Lede 校园网登录助手" badge="OUTDATED" />
<SiteCard title="luci-app-ustb" url="https://github.com/WROIATE/luci-app-ustb" desc="OpenWrt Luci 校园网登录插件" badge="OUTDATED" />
<SiteCard title="ustb-login" url="https://github.com/kotoyuuko/ustb-login" desc="USTB 网络登录脚本" badge="OUTDATED" />
<SiteCard title="ustb-login-daemon" url="https://github.com/Jason23347/ustb-login-daemon" desc="校园网周期性登录守护进程" badge="OUTDATED" />
<SiteCard title="LoginUSTBNetwork" url="https://github.com/USTBDeveloper/LoginUSTBNetwork" desc="校园网登录多种方式" badge="OUTDATED" />
<SiteCard title="ustb_login" url="https://github.com/z52527/ustb_login" desc="USTB 网络登录脚本" badge="OUTDATED" />
<SiteCard title="USTB_login" url="https://github.com/LoveFlamehaze/USTB_login" desc="北科大校园网自动登录" badge="OUTDATED" />
</template>
</SiteSection>
...
<SiteCard title="USTB-Awesome-JS" url="https://github.com/isHarryh/USTB-Awesome-JS" desc="锐格 / 慕课 / 超星等线上平台辅助脚本合集（油猴）" />
...
<template #outdated>
<SiteCard title="USTB-Course-ICS-Exporter" url="https://github.com/NicodeSS/USTB-Course-ICS-Exporter" desc="从北科大微教务导出课表 ICS 文件" badge="OUTDATED" />
<SiteCard title="ustb-daily-with-hass" url="https://github.com/terrance-liang/ustb-daily-with-hass" desc="基于 Home Assistant 位置数据的平安报" badge="OUTDATED" />
<SiteCard title="USTB_edusys" url="https://github.com/shinerio/USTB_edusys" desc="北京科技大学本科教务管理系统" badge="OUTDATED" />
<SiteCard title="USTB-api" url="https://github.com/abowloflrf/USTB-api" desc="elearning.ustb.edu.cn 课程 API（PHP）" badge="OUTDATED" />
<SiteCard title="ustb-elearning" url="https://github.com/kotoyuuko/ustb-elearning" desc="USTB Elearning System API" badge="OUTDATED" />
</template>
</SiteSection>
...
<template #outdated>
<SiteCard title="Uranus" url="https://github.com/ustb-owl/Uranus" desc="MIPS 处理器（MaxXing & USTB NSCSCC）" badge="OUTDATED" />
<SiteCard title="TinyMIPS" url="https://github.com/ustb-owl/TinyMIPS" desc="从零搭建完整计算机系统的本科教学项目" badge="OUTDATED" />
<SiteCard title="judger" url="https://github.com/USTB-LETTers/judger" desc="Docker 沙箱内运行用户代码并比对输出" badge="OUTDATED" />
</template>
</SiteSection>
